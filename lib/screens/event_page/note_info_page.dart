...
class NoteInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<EventCubit>(context).init(page);
    textState =
  ...
  Widget buildNote(EventState state, BuildContext context) {
            ...
            itemBuilder: (context, index) {
              if (state.isBookmarkedNoteMode) {
                ...
                if (state.allNotes[index].description != null) {
                  if (state.allNotes[index].description!
                      .toLowerCase()
              ...
              title: Column(
                ...
                children: [
                  ...
                  state.allNotes[index].image != '' &&
                          state.allNotes[index].image != null && state.allNotes[index].image != ''
                      ? ClipRRect(
                          borderRadius: const BorderRadius.all(
                            Radius.circular(8),
                          ),
